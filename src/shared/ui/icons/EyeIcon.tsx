...
export const EyeIcon = ({ isOpen = false }: EyeIconProps) => {
    return isOpen ? <EyeOpenIcon /> : <EyeOffIcon />;
};
...
function EyeOpenIcon() {
    return (
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            />
            <path
                d="M21 12C21 12 17 19 12 19C7 19 3 12 3 12C3 12 7 5 12 5C17 5 21 12 21 12Z"
                stroke="currentColor"
                strokeWidth="2"
                strokeLinecap="round"
                strokeLinejoin="round"
...
function EyeOffIcon() {
    return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
                <filter id="filter0_i_1046_84" x="1.15625" y="2" width="21.6883" height="24" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
